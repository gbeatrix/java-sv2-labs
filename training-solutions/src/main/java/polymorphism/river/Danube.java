...
public class Danube extends River {
    ...
    public static void main(String[] args) {
        List<String> capitals = Arrays.asList("Bécs", "Pozsony", "Budapest", "Belgrád");
        Water water = new Danube("Duna", 2850, capitals);
        River river = new Danube("Duna", 2850, capitals);
        System.out.println(river.getName());
        System.out.println(river.getLength());
        Danube danube = new Danube("Duna", 2850, capitals);
